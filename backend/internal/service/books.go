...
// ListBooks 查询图书。
func (s *Service) ListBooks(keyword string, categoryID *int64, region string) ([]models.Book, error) {
	return s.repo.ListBooks(strings.TrimSpace(keyword), categoryID, strings.TrimSpace(region))
}

// ListRegions 返回各地区及其馆藏种类数。
